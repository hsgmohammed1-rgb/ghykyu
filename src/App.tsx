...
function Footer() {
  ...
  return (
    <footer className="fixed bottom-2 w-full text-center text-sm text-gray-500 opacity-50 z-50 pointer-events-none">
      <span 
        className="pointer-events-auto cursor-pointer font-bold px-2"
